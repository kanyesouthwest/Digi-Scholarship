        ...
        if(is_uploaded_file($_FILES['csvfile']['tmp_name'])){
            ...
            while(($line = fgetcsv($csvFile)) !== FALSE){
                ...
                if($prevResult->num_rows > 0){
                    ...
                    $sql = "UPDATE student_details SET ID = '".$ID."', first_name = '".$first_name."', last_name = '".$last_name."', year = '".$year."', student_ID = '".$student_ID."' ";
                    
                } else {
                    // Insert student data in the database
                    $sql="INSERT INTO student_details (ID, first_name, last_name, `year`, student_ID) VALUES ('$ID', '$first_name', '$last_name', '$year', '$student_ID')";
